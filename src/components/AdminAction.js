...
//     const [selectedDoctorCharge, setSelectedDoctorCharge] = useState(null);
//     const [selectedChannelingCharge, setSelectedChannelingCharge] = useState(null);
//     const [dressingItem, setDressingItem] = useState('');
//     const [dressingPrice, setDressingPrice] = useState('');
//     const [dressingItems, setDressingItems] = useState([]);
//     const [selectedDressingItem, setSelectedDressingItem] = useState(null);
...
//         const doctorChargesSnapshot = await getDocs(collection(db, 'doctorCharges'));
//         const channelingChargesSnapshot = await getDocs(collection(db, 'channelingCharges'));
//         const dressingItemsSnapshot = await getDocs(collection(db, 'dressingItems'));

//         setDressingItems(dressingItemsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })));
//         setDoctors(doctorsSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })));
//         setDoctorCharges(doctorChargesSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })));
//         setChannelingCharges(channelingChargesSnapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })));
//     };
...
//     const handleAddDressingItem = async () => {
//         if (dressingItem.trim() === '' || dressingPrice.trim() === '') {
//             alert('Please enter item and price');
//             return;
//         }
//         try {
//             await addDoc(collection(db, 'dressingItems'), {
//                 item: dressingItem,
//                 price: parseFloat(dressingPrice),
//             });
//             alert('Dressing item added!');
//             setDressingItem('');
//             setDressingPrice('');
//             fetchData();
//         } catch (error) {
//             console.error('Error adding dressing item:', error);
//         }
//     };

//     const handleUpdateDressingItem = async () => {
//         if (!selectedDressingItem) return;
//         try {
//             await updateDoc(doc(db, 'dressingItems', selectedDressingItem.id), {
//                 item: dressingItem,
//                 price: parseFloat(dressingPrice),
//             });
//             alert('Dressing item updated!');
//             setSelectedDressingItem(null);
//             setDressingItem('');
//             setDressingPrice('');
//             fetchData();
//         } catch (error) {
//             console.error('Error updating dressing item:', error);
//         }
//     };

//     const handleDeleteDressingItem = async () => {
//         if (!selectedDressingItem) return;
//         try {
//             await deleteDoc(doc(db, 'dressingItems', selectedDressingItem.id));
//             alert('Dressing item deleted!');
//             setSelectedDressingItem(null);
//             setDressingItem('');
//             setDressingPrice('');
//             fetchData();
//         } catch (error) {
//             console.error('Error deleting dressing item:', error);
//         }
//     };
...
//                 </div>
//                 <div className="form-containers">
//                     <h2>Dressing Items</h2>
//                     <input
//                         type="text"
//                         placeholder="Dressing Item Name"
//                         value={dressingItem}
//                         onChange={(e) => setDressingItem(e.target.value)}
//                     />
//                     <input
//                         type="number"
//                         placeholder="Price"
...
//                     />
//                     <button className="add-button" onClick={handleAddDressingItem}>
//                         Add Item
//                     </button>

//                     <select
//                         onChange={(e) => {
//                             const item = dressingItems.find(i => i.id === e.target.value);
//                             setSelectedDressingItem(item);
//                             setDressingItem(item ? item.item : '');
//                             setDressingPrice(item ? item.price : '');
//                         }}
//                         value={selectedDressingItem ? selectedDressingItem.id : ''}
//                     >
//                         <option value="">Select Item to Edit/Delete</option>
...
//                     <button className="edit-button" onClick={handleUpdateDressingItem} disabled={!selectedDressingItem}>
//                         Update
//                     </button>
//                     <button className="delete-button" onClick={handleDeleteDressingItem} disabled={!selectedDressingItem}>
//                         Delete
//                     </button>
//                 </div>
//             </div>
